						...
						<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
							<div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                                <div class="border d-flex flex-column flex-center rounded-4 w-md-600px p-10" style="background-color: #fffbf0 !important ; border-color: #c59400 !important">
                                    <form class="w-100" id="signinform">
                                        @csrf
                                        <div class="text-center mb-11">
                                            <h1 class="fw-bolder mb-3" style="color: #5e4807">Sign In</h1>
                                        ...
                                        <div class="d-grid mb-10">
                                            <button type="button" class="btn btn-primary save-signin">
                                                <span class="indicator-label">Sign In</span>
                                            </button>
                                        </div>
                                    </form>
                                    <div class="text-gray-500 text-center fw-semibold fs-6">Not a Member yet?
                                    <a href="{{ route('auth.reg.index') }}" class="link-primary">Sign up</a></div>
                                </div>
							</div>
						</div>
					</div>
